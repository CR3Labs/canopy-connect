...
import { Context as CanopyConnectContext } from '../components/CanopyConnect';
import {
  SIWEContext,
  SIWEConfig,
  StatusState,
...
export const SIWEProvider = ({
  ...
  // SIWEProvider must be wrapped outside of CanopyConnectProvider so that the
  // CanopyConnectButton and other UI can use SIWE context values.
  if (useContext(CanopyConnectContext)) {
    throw new Error('CanopyConnectProvider must be mounted inside SIWEProvider.');
  }
