...
ConnectButtonRenderer.displayName = 'CanopyConnectButton.Custom';

function CanopyConnectButtonInner({
  label,
  showAvatar,
  separator,
}: {
...
CanopyConnectButton.Custom = ConnectButtonRenderer;
