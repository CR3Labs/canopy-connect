...
export const walletConfigs: {
  ...
  'me.rainbow': {
    ...
    downloadUrls: {
      ...
      website: 'https://rainbow.me/?utm_source=canopy-connect',
      android:
        'https://play.google.com/store/apps/details?id=me.rainbow&referrer=utm_source%3Dcanopy-connect&utm_source=canopy-connect',
      ios: 'https://apps.apple.com/app/rainbow-ethereum-wallet/id1457119021?pt=119997837&ct=canopy-connect&mt=8',
      chrome: 'https://rainbow.me/extension?utm_source=canopy-connect',
      edge: 'https://rainbow.me/extension?utm_source=canopy-connect',
      brave: 'https://rainbow.me/extension?utm_source=canopy-connect',
    },
    getWalletConnectDeeplink: (uri: string) => {
      return isAndroid()
        ? uri
