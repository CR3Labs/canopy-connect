...
import { Types } from 'canopy-connect';
...
type ContextValue = {
  ...
  options: Types.CanopyConnectOptions;
  setOptions: React.Dispatch<React.SetStateAction<Types.CanopyConnectOptions>>;
  hideBalance: boolean;
...
export const TestBenchProvider: React.FC<TestBenchProviderProps> = ({
  ...
  const [ckOptions, setOptions] = useState<Types.CanopyConnectOptions>(options);
