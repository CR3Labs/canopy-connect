...
/** TODO: import this data from the canopy-connect module */
    ...
    <>
      <main>
        <div className="panel">
          ...
          <CanopyConnectButton label={label} />
          {isConnected && (
      ...
      <aside>
        ...
        <Actions />
        <h2>CanopyConnectButton props</h2>
        <Textbox
          label="CanopyConnectButton Label"
          value={label}
          onChange={(e: any) => {
        ...
        />
        <h2>CanopyConnectProvider props</h2>
        <Select
          label="Theme"
